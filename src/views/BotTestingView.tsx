            ...
            <div className="flex-1 flex flex-col bg-slate-800/50 border border-slate-700/50 rounded-2xl overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-slate-700/50 bg-slate-800/80">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="text-white font-semibold">OEM Bot Simulator</h3>
                            <p className="text-slate-400 text-sm">Twilio Bypass - Direkte Bot-Logik</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex items-center gap-2 px-3 py-2 bg-slate-900/50 rounded-lg">
                            ...
                            <input
                                ...
                                className="bg-transparent text-slate-300 text-sm w-32 focus:outline-none"
                                placeholder="+49..."
                            />
                        </div>
                        <button
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    {messages.length === 0 && (
                        <div className="h-full flex flex-col items-center justify-center text-center">
                            ...
                            <h4 className="text-white font-medium mb-2">Bot Simulator bereit</h4>
                            ...
                            <div className="flex flex-wrap gap-2 max-w-md justify-center">
                                {quickPrompts.map((prompt, i) => (
                                    <button
                                        ...
                                        className="px-3 py-1.5 bg-slate-700/50 hover:bg-slate-700 text-slate-300 text-xs rounded-full transition-colors"
                                    >
                                        {prompt}
                                    </button>
                                ))}
                    ...
                    {isLoading && (
                        ...
                        >
                            <div className="flex items-center gap-2 px-4 py-3 bg-slate-700 rounded-2xl">
                                ...
                                <span className="text-slate-300 text-sm">Bot denkt nach...</span>
                            </div>
                        </motion.div>
                    )}
                ...
                <div className="p-4 border-t border-slate-700/50">
                    <div className="flex gap-3">
                        <input
                            ...
                            className="flex-1 px-4 py-3 bg-slate-900/50 border border-slate-700/50 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:border-green-500/50"
                            disabled={isLoading}
                        />
                        <motion.button
                            onClick={sendMessage}
            ...
            <div className="w-80 flex flex-col gap-4">
                ...
                <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-5">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h4 className="text-white font-semibold">OEM Statistiken</h4>
                            <p className="text-slate-400 text-xs">Letzte 7 Tage</p>
                        </div>
                    </div>
                    ...
                    {oemStats ? (
                        <div className="space-y-3">
                            <div className="flex justify-between items-center">
                                <span className="text-slate-400 text-sm">Erfolgsquote</span>
                                <span className={`font-bold ${oemStats.resolution_rate >= 70 ? 'text-green-400' : 'text-yellow-400'}`}>
                ...
                {orderDetails && (
                    ...
                    >
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <h4 className="text-white font-semibold">Order Details</h4>
                                <p className="text-slate-400 text-xs">{orderDetails.status}</p>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3 text-sm">
                            {orderDetails.requested_part_name && (
                                <div>
                                    ...
                                    <span className="text-white ml-2">{orderDetails.requested_part_name}</span>
                                </div>
                            )}
                            ...
                            {orderDetails.oem_number && (
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-green-400 font-mono">{orderDetails.oem_number}</span>
                            ...
                            {orderDetails.vin && (
                                <div>
                                    ...
                                    <span className="text-slate-300 ml-2 font-mono text-xs">{orderDetails.vin}</span>
                                </div>
                            )}
                        </div>
                    </motion.div>
                ...
                <div className="bg-slate-800/30 border border-slate-700/30 rounded-2xl p-5">
                    <h4 className="text-slate-400 text-xs uppercase tracking-wider mb-3">Test-Szenarien</h4>
