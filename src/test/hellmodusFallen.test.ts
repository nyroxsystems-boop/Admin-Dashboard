 ...
 *
 * Anlass: nach dem Umstellen sah der Hellmodus gut aus — bis auf den aktiven
 * Eintrag in der Seitenleiste, der fast unsichtbar war. `text-white` auf einem
 * DURCHSCHEINENDEN Akzentverlauf: im Dunkeln richtig, im Hellen weg.
 *
